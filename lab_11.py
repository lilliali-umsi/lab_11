...
def filter_properties(film):
    """
    Accepts a dictionary <film>, extracts properties listed in <FILM_PROPERTIES> of the given <film> 
    and returns a dictionary containing corresponding key-value pairs

    Parameters:
        film (dict): dictionary containing properties of the film

    Returns:
        record (dict): new dictionary containing key-value pairs corresponding to <FILM_PROPERTIES>
